  ...
  return (
    <selectedNoteContext.Provider value={{selectedNote, setSelectedNote}}>
      <main className="main-container flex flex-col relative sm:flex-row dark:bg-fullBlack flex-auto h-full flex-grow">
        ...
        <div className={`secondary bg-white dark:bg-black absolute top-0 transition-all duration-200 ease-linear w-full h-full ${displayNote ? 'translate-x-0':'!sm:translate-x-0 translate-x-[2000px] sm:!block'} z-10 sm:z-[1] !sm:block sm:static  sm:w-3/5 lg:w-2/3 !sm:translate-x-0 sm:h-full`}>
          {
           outlet()
          }
        </div>
